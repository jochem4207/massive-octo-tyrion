...
public class TankDetailCardAdapter extends RecyclerView.Adapter<TankDetailCardAdapter.ViewHolder> {
    private static TankItemClickListener itemClickListener;
    private ArrayList<TankDetailCard> mDataset;


    public TankDetailCardAdapter(ArrayList<TankDetailCard> myDataset) {
        mDataset = myDataset;
    }
    ...
    public void addItem(TankDetailCard data, int index) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment_tank_detail_list, parent, false);
